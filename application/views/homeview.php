            ...
            <div class="row gx-5 align-items-center">
                <div class="col-xxl-5">
                    ...
                    <div class="text-center text-xxl-start">
                        <div class="badge bg-gradient-primary-to-secondary text-white mb-2">
                            <div class="text-uppercase">Inovatif &middot; Kreatif &middot; Imajinatif</div>
                        </div>
                        <div class="fs-3 fw-light text-muted">
                            <?= $sekolah ?>
                        </div>
                        <h1 class="display-3 fw-bolder mb-5"><span class="text-gradient d-inline">Menjadi MI Kreatif
                                Inovatif berdasarkan Iman dan Taqwa.</span></h1>
                        <div class="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xxl-start mb-3">
                            <a class="btn btn-success btn-lg px-5 py-3 me-sm-3 fs-6 fw-bolder" href="resume.html">Resume</a>
                ...
                <div class="col-xxl-7 text-center">
                    ...
                    <div class="d-flex justify-content-center mt-5 mt-xxl-0">
                        <div class="profile bg-gradient-primary-to-secondary">
                            ...
                            <img class="profile-img" src="<?= base_url() ?>assets/img/<?= $item->foto_kepsek ?>"
                                alt="..." />
                            <div class="dots-1">
                                <!-- SVG Dots-->
                    ...
                    <h4 class="fw-bolder text-gradient">
                        <?= $item->nama_kepsek ?>
                    </h4>
                </div>
            </div>
            ...
            <div class="row gx-3 justify-content-center">
                <div class="col-xxl-10">
                    ...
                    <div class="text-center my-5">
                        <h2 class="display-5 fw-bolder"><span class="text-gradient d-inline">Sambutan Kepala
                                Sekolah</span>
                        </h2>
                        <h4 class="mt-3 text-muted lh-base">
                            <p>Assalamualaikum. Wr. Wb</p>
                            <?= $item->sambutan_kepsek ?>
                            <p>Wassalamu'alaikum. Wr. Wb</p>
                        </h4>
                        <!-- <div class="d-flex justify-content-center fs-2 gap-4">
                            <a class="text-gradient" href="#!"><i class="bi bi-facebook"></i>
                                <?= $item->facebook ?>
                            </a>
                            <a class="text-gradient" href="#!"><i class="bi bi-instagram"></i>
                                <?= $item->instagram ?>
                            </a>
                            <a class="text-gradient" href="#!"><i class="bi bi-whatsapp"></i>
                                <?= $item->email ?>
                            </a>
                            <a class="text-gradient" href="#!"><i class="bi bi-whatsapp"></i>
                                <?= $item->telepon ?>
    ...
    <div class="container px-3">
        <div class="row gx-3 justify-content-center">
            <div class="col-xxl-12">
                <div class="text-center my-5">
                    <h2 class="display-5 fw-bolder"><span class="text-gradient d-inline">Kegiatan</span>
                    </h2>
                </div>
                        ...
                        foreach ($kegiatan as $item) { ?>
                            <div class="col-md-6 mb-4">
                                <div class="card shadow-sm">
                                    <img class="rounded" src="<?= base_url('assets/img/') ?><?= $item->foto ?>" alt=""
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div class="btn-group">
                                                <button type="button"
                                                    class="btn btn-sm btn-outline-success">Selengkapnya</button>
                                            </div>
...
<section class="bg-light py-3">
    <div class="container px-3">
        <div class="row gx-3 justify-content-center">
            <div class="col-xxl-12">
                <div class="text-center my-5">
                    <h2 class="display-5 fw-bolder"><span class="text-gradient d-inline">Prestasi</span>
                    </h2>
                </div>
                <main class="container">
                    <div class="row m-4 text-center">
...
<section class="bg-white py-3">
    <div class="container px-3">
        <div class="row gx-3 justify-content-center">
            <div class="col-xxl-12">
                <div class="text-center my-5">
                    <h2 class="display-5 fw-bolder"><span class="text-gradient d-inline">Pengajar</span>
                    </h2>
                </div>
                <main class="container">
                    <div class="row m-4 text-center">
                        ...
                        foreach ($pengajar as $item) { ?>
                            <div class="col">
                                <img src="<?= base_url('assets/img/') ?><?= $item->foto ?>" width="140" height="140"
